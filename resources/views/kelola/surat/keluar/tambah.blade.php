...
@section('content_header')
    <h1>Tambah Surat Keluar ({{ Auth::user()->bidang }})</h1>
@stop
            ...
            <form action="{{url()->current()}}/post" method="post" enctype="multipart/form-data">
                <div class="card-body">
                    ...
                    @endif
                        ...
                        @endif
                    @csrf
                    <x-adminlte-input-date value="{{ old('tanggal_keluar') }}" name="tanggal_keluar" :config="$conf_tglsurat"
                                           placeholder="Masukkan Tanggal Keluar..." label="Tanggal Keluar">
